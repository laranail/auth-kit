...
For a ready-made API route set and Sanctum response handling, use `laranail/auth-preset` and see its [API routes guide](../../laranail-auth-preset/docs/api-routes.md).